...
# TODO: Buil RoPE embeddings out from scratch
...
class MistralAttention(nn.Module):
    ...
    def __init__(self, dim):
        """Initialize the Mistral Attention block."""
        super().__init__()
    ...
    def forward(self, x):
        ...
        attn_output = self.o_proj(
            q + k + v
        )  # TODO: This is simplified for demonstration, create proper self attention mechansim
        return attn_output
...
class MistralDecoderLayer(nn.Module):
    ...
    def __init__(self, dim):
        """Initialize the Mistral Decoder Layer."""
        super().__init__()
